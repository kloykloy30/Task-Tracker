...
<body>
  <div id="wrapper">
    <div id="loginForm">
      <div class="succes">
        <p><strong>Registration Successful</strong><br />
        You can now login to your account.</p>
      </div>

      <form name="loginForm" class="box login" method="post" action="login-exec.php">
        <fieldset class="boxBody">
          <label>Username</label> <input type="text" name="login" id="login" tabindex="1" placeholder="Username" required="" /><label><a href="#" class="rLink" tabindex="5">Forgot your password?</a>Password</label> <input name="password" type="password" id="password" tabindex="2" required="" />
        </fieldset>
    ...
    <div id="right-wrapper">
      ...
      <div id="reglog">
        <p>No account yet?</p>
        <div class="rightbut"><a href="register-form.php">Register</a></div>
      </div>
      -->
    </div>
  </div>
