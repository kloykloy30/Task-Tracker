...
<head>
  ...
  <title>Task-Tracker Reset</title>
  <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
...
<body>
  <div id="wrapper">
    <div id="loginForm">
      <form name="loginForm" class="box login" method="post" action="<?php echo $exec ?>">
        <?php
		...
		<footer>
			<div class="submit">
			  <input type="submit" name="Submit" class="btnLogin" value="Reset" tabindex="7" />
			</div>
		</footer>
