...
<div id="templates" style="display:none;">
	<div class='project-head head'> 
			...
			<div class='bars'>
				...
				<div class='title'></div>
				<div class='title-edit'><input type="text" name="title-input" class="title-input" value="" placeholder="Edit Project Title"></div>
				...
				<tr style='vertical-align:top'>
					...
					<td>
						<div class='tags background-gradient-hue' >
							<div class='term-search background-hue'>tags:</a></div>
							<ul class='terms'></ul>
							<input class='tag-input' type='text' name='tag-input' autocomplete='array:tags'>
						</div>
